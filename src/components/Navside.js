...
const Navside = () => (
    <nav className="navside">
        <ul>
            ...
            <NavLink to="/ustawienia" className="navside__link" activeClassName="navside_active">
